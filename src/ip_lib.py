...
class IPWrapper(SubProcessBase):
    ...
    def add_vxlan(self, name, vni, dev, group=None, ttl=None, tos=None,
        ...
        print("Check VXLAN interface: ", dev)
...
def get_devices_with_ip(namespace, name=None, **kwargs):
    ...
    if not link_args:
        ...
        #print(">>>>>some: ", namespace, device[0]['index'], **kwargs)
...
def get_devices_info(namespace, **kwargs):
    ...
    for device in devices:
        ...
        #print(">>>>>ret: ", ret)
        #print("     ifla_link: ", ifla_link)
        #print("     ifla_linkinfo: ", ifla_linkinfo)
    
    #print(">>>  retval(): ", retval)
    #print("     retval(): ", retval.values())
    ...
    #print(">    retval.values(): ", list(retval.values()))
